...
If one demands that a theory\footnote{In particle physics parlance, `a theory'
means a mathematical model for some system (possibly the whole universe) which
includes an inventory of degrees of freedom (generally particles) and a 
...
transformations. You can think of `a CFT' as being a particular instantiation of
...
in a new way. This is actually a true statement in generally (non-conformal) 
...
anything in the way of putting them next to each other.
